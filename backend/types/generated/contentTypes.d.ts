...
export interface ApiCartCart extends Schema.CollectionType {
  ...
  attributes: {
    games: Attribute.Relation<'api::cart.cart', 'manyToMany', 'api::game.game'>;
    ...
    days: Attribute.Integer & Attribute.DefaultTo<1>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiGameGame extends Schema.CollectionType {
  ...
  attributes: {
    ...
    comments: Attribute.Relation<
      ...
      'api::comment.comment'
    >;
    carts: Attribute.Relation<'api::game.game', 'manyToMany', 'api::cart.cart'>;
    price: Attribute.Integer & Attribute.DefaultTo<50>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
